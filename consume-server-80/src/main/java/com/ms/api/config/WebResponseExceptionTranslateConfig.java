...
//                // do something with header or response
                ...
                return new ResponseEntity(responseEntity , headers , responseEntity.getStatusCode());
...
//    @Bean(name = "webResponseExceptionTranslator")
//    public ApiError webResponseExceptionTranslator() {
//        return ApiError.builder().code(401).message("filure").error("未授权").build();
//    }
}
